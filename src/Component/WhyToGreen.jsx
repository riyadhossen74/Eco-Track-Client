...
const WhyToGreen = () => {
  return (
    ...
    <div className="grid grid-cols-3 justify-between container mx-auto  my-10">
      ...
      <div className="flex flex-col space-y-2 py-3 items-center justify-center  p-2 w-[300px] text-center bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ">
